...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (empty($url_embed)) {
        $error = 'La URL del embed (Spotify/YouTube) es obligatoria.';
    } elseif (empty($fecha)) {
        $error = 'La fecha de publicación es obligatoria.';
    } else {
        try {
            $stmt = $pdo->prepare("INSERT INTO podcasts 
                (titulo, descripcion, imagen, url_embed, duracion, fecha_publicacion, estado, usuario_id) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$titulo, $descripcion, $imagen, $url_embed, $duracion, $fecha, $estado, $usuario_id]);
            
            header('Location: index.php?mensaje=creado');
            exit;
        } catch(PDOException $e) {
            $error = 'Error al crear el podcast: ' . $e->getMessage();
        }
    }
}
?>
...
<body>
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <div class="breadcrumb">
                    <i class="fas fa-home"></i> / <a href="index.php">Podcasts</a> / <span>Nuevo</span>
                </div>
            </div>
        ...
        <div class="content-area">
            <section class="hero">
                <div>
                    <h1>Nuevo <span>Podcast</span></h1>
                    <p>Completa todos los campos para crear un nuevo podcast</p>
                </div>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="titulo" name="titulo" class="form-control" 
                                   ...
                                   placeholder="Ej: Aumentan casos de hackeo de WhatsApp" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" id="fecha_publicacion" name="fecha_publicacion" 
                                   class="form-control" 
                                   value="<?php echo htmlspecialchars($_POST['fecha_publicacion'] ?? date('Y-m-d')); ?>" 
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descripcion" name="descripcion" class="form-control" 
                                  placeholder="Breve descripción del podcast"><?php echo htmlspecialchars($_POST['descripcion'] ?? ''); ?></textarea>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="url" id="url_embed" name="url_embed" class="form-control" 
                                   value="<?php echo htmlspecialchars($_POST['url_embed'] ?? ''); ?>" 
                                   placeholder="https://open.spotify.com/episode/..." required>
                            <div class="help-text">
                                <i class="fas fa-info-circle"></i>
                                Pega la URL de Spotify, YouTube o la URL del embed.
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="duracion">Duración</label>
                            <input type="text" id="duracion" name="duracion" class="form-control" 
                                   value="<?php echo htmlspecialchars($_POST['duracion'] ?? ''); ?>" 
