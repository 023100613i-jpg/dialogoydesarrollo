...
<head>
    ...
    <title>Ver Boletín · DDP Noticias</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .view-card .meta .item .value {
            font-weight: 500;
        }

        .view-card .contenido .foto-portada {
            margin: 1.5rem 0;
            text-align: center;
        }
        .view-card .contenido .foto-portada img {
            max-width: 100%;
            max-height: 300px;
            border-radius: var(--ddp-radius);
            border: 1px solid var(--ddp-border);
        ...
        .view-card .contenido .foto-portada .no-image {
            background: var(--ddp-bg);
            padding: 3rem;
            border-radius: var(--ddp-radius);
            border: 1px solid var(--ddp-border);
        ...
        .view-card .contenido .foto-portada .no-image i {
            font-size: 3rem;
            display: block;
            margin-bottom: 0.5rem;
        }
        .view-card .contenido .resumen {
            font-size: 1.1rem;
            color: var(--ddp-text-secondary);
        ...
        @media (max-width: 600px) {
            ...
            .view-card .meta { grid-template-columns: 1fr; }
            .actions-bar { flex-direction: column; }
            .actions-bar .btn { justify-content: center; }
        }
        .view-card .contenido .resumen .resumen-html {
    margin-top: 0.75rem;
    font-size: 1rem;
    color: var(--ddp-text);
    line-height: 1.7;
}
.view-card .contenido .resumen .resumen-html p { margin-bottom: 0.5rem; }
.view-card .contenido .resumen .resumen-html ul,
.view-card .contenido .resumen .resumen-html ol { margin: 0.5rem 0 0.5rem 1.25rem; }
.view-card .contenido .resumen .resumen-html img { max-width: 100%; border-radius: 8px; margin: 0.5rem 0; }
.view-card .contenido .resumen .resumen-html strong { color: var(--ddp-red); }
.view-card .contenido .resumen .resumen-html a { color: var(--ddp-red); text-decoration: underline; }
.view-card .contenido .resumen .resumen-html table {
    width: 100%; border-collapse: collapse; margin: 0.5rem 0;
}
.view-card .contenido .resumen .resumen-html table td,
.view-card .contenido .resumen .resumen-html table th {
    border: 1px solid var(--ddp-border); padding: 0.4rem 0.6rem; font-size: 0.9rem;
}
    </style>
</head>
<body>
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="index.php"><i class="fas fa-file-pdf"></i> Boletines</a></li>
            <li><a href="#"><i class="fas fa-newspaper"></i> Reportajes</a></li>
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <div class="breadcrumb">
                    <i class="fas fa-home"></i> / <a href="index.php">Boletines</a> / <span>Ver</span>
                </div>
            </div>
        ...
        <div class="content-area">
            <section class="hero">
                <div>
                    <h1><span>Boletín</span> #<?php echo $boletin['id']; ?></h1>
                    <p><?php echo htmlspecialchars($boletin['numero_boletin'] ?? 'Sin número'); ?></p>
                </div>
            ...
            <div class="view-card">
                <div class="meta">
                    <div class="item">
                        <div class="label">Número de boletín</div>
                        <div class="value"><strong><?php echo htmlspecialchars($boletin['numero_boletin'] ?? 'Sin número'); ?></strong></div>
                    </div>
                    <div class="item">
                        <div class="label">Fecha de publicación</div>
                        <div class="value"><?php echo isset($boletin['fecha_publicacion']) ? date('d/m/Y', strtotime($boletin['fecha_publicacion'])) : '-'; ?></div>
                    </div>
                    <div class="item">
                        <div class="label">Publicado por</div>
                        <div class="value"><?php echo htmlspecialchars($boletin['usuario_nombre'] ?? 'Sin asignar'); ?></div>
                    </div>
                </div>
                    ...
                    <div class="foto-portada">
                        <?php if (!empty($boletin['foto_portada'])): ?>
                            <img src="../<?php echo htmlspecialchars($boletin['foto_portada']); ?>" 
                                 alt="<?php echo htmlspecialchars($boletin['numero_boletin']); ?>"
                                 onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div style="display:none;" class="no-image">
...
<div class="resumen">
    ...
    <div class="resumen-html"><?php echo $resumenHTML; ?></div>
</div>
<?php endif; ?>

                    <?php if (!empty($boletin['archivo_pdf'])): ?>
                    <a href="../<?php echo htmlspecialchars($boletin['archivo_pdf']); ?>" target="_blank" class="pdf-download">
                ...
                <div class="actions-bar">
                    <a href="editar.php?id=<?php echo $boletin['id']; ?>" class="btn btn-red">
                        <i class="fas fa-edit"></i> Editar Boletín
                    </a>
                    <a href="index.php" class="btn btn-outline">
