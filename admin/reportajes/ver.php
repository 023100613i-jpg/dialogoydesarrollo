...
<head>
    ...
    <title>Ver Reportaje · DDP Noticias</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .view-card .meta .item .tag.published {
            background: #d4edda;
            color: var(--ddp-success);
        }
        .view-card .meta .item .tag.draft {
            background: #fff3cd;
            color: var(--ddp-warning);
        }
        .view-card .meta .item .destacado {
            color: var(--ddp-warning);
        }
        .view-card .meta .item .no-destacado {
            color: var(--ddp-text-secondary);
        }
        ...
        .view-card .contenido .desarrollo {
            font-size: 1rem;
            line-height: 1.9;
        }
        .view-card .contenido .desarrollo img {
            max-width: 100%;
            height: auto;
            border-radius: var(--ddp-radius);
        }
        
        .view-card .contenido .foto-principal {
            margin: 1.5rem 0;
            text-align: center;
        }
        .view-card .contenido .foto-principal img {
            max-width: 100%;
            max-height: 400px;
            border-radius: var(--ddp-radius);
            border: 1px solid var(--ddp-border);
        ...
        .view-card .contenido .foto-principal .caption {
            font-size: 0.8rem;
            color: var(--ddp-text-secondary);
            margin-top: 0.5rem;
        }
        .view-card .contenido .foto-principal .no-image {
            background: var(--ddp-bg);
            padding: 3rem;
            border-radius: var(--ddp-radius);
            border: 1px solid var(--ddp-border);
        ...
        .view-card .contenido .foto-principal .no-image i {
            font-size: 3rem;
            display: block;
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="index.php"><i class="fas fa-newspaper"></i> Reportajes</a></li>
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <div class="breadcrumb">
                    <i class="fas fa-home"></i> / <a href="index.php">Reportajes</a> / <span>Ver</span>
                </div>
            </div>
        ...
        <div class="content-area">
            <section class="hero">
                <div>
                    <h1><span>Reportaje</span> #<?php echo $reportaje['id']; ?></h1>
                    <p><?php echo htmlspecialchars($reportaje['titulo'] ?? 'Sin título'); ?></p>
                </div>
            ...
            <div class="view-card">
                ...
                <div class="meta">
                    <div class="item">
                        ...
                        <div class="value"><?php echo htmlspecialchars($reportaje['titulo'] ?? 'Sin título'); ?></div>
                    </div>
                    <div class="item">
                        <div class="label">Publicado por</div>
                        <div class="value"><?php echo htmlspecialchars($reportaje['usuario_nombre'] ?? 'Sin asignar'); ?></div>
                    </div>
                    <div class="item">
                        <div class="label">Fecha de publicación</div>
                        <div class="value"><?php echo isset($reportaje['fecha_publicacion']) ? date('d/m/Y', strtotime($reportaje['fecha_publicacion'])) : '-'; ?></div>
                    </div>
                    <div class="item">
                        <div class="label">Destacado</div>
                        <div class="value">
                            <?php if ($reportaje['es_destacado'] ?? 0): ?>
                                <span class="destacado"><i class="fas fa-star"></i> Sí</span>
                            <?php else: ?>
                                <span class="no-destacado"><i class="far fa-star"></i> No</span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="contenido">
                    ...
                    <div class="foto-principal">
                        <?php if (!empty($reportaje['foto_principal'])): ?>
                            ...
                            <div class="caption">Foto principal</div>
                        <?php else: ?>
                            <div class="no-image">
                                <i class="fas fa-image"></i>
                    ...
                    <div class="pdf-adjunto">
                        ...
                        <a href="../<?php echo htmlspecialchars($reportaje['pdf_adjunto']); ?>" target="_blank">
                            <?php echo htmlspecialchars(basename($reportaje['pdf_adjunto'])); ?>
                    ...
                    <div class="resumen">
                        <strong>Resumen:</strong> <?php echo htmlspecialchars($reportaje['resumen_corto']); ?>
                    </div>
                    <?php endif; ?>

                    <!-- Desarrollo -->
                    <div class="desarrollo">
                        <?php echo $reportaje['desarrollo'] ?? '<p>No hay contenido disponible.</p>'; ?>
                    </div>
                </div>

                <!-- ACCIONES -->
                <div class="actions-bar">
                    <a href="editar.php?id=<?php echo $reportaje['id']; ?>" class="btn btn-red">
                        <i class="fas fa-edit"></i> Editar Reportaje
                    </a>
                    <a href="index.php" class="btn btn-outline">
