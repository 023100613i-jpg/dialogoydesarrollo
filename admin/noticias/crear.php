...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (empty($fecha)) { $error = 'La fecha de publicación es obligatoria.'; }
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO noticias (titulo, foto, link_externo, fecha_publicacion, usuario_id) 
                                   VALUES (?, ?, ?, ?, ?)");
            $stmt->execute([$titulo, $foto, $link_externo, $fecha, $usuario_id]);
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-card {
            ...
            box-shadow: var(--ddp-shadow); width: 100%;
        }
        .form-group { margin-bottom: 1.5rem; }
        .form-group label {
            display: block; font-weight: 500; margin-bottom: 0.3rem; color: var(--ddp-text);
        }
        .form-group label .required { color: var(--ddp-red); }
        .form-group .help-text {
            font-size: 0.75rem; color: var(--ddp-text-secondary); margin-top: 0.2rem;
        }
        .form-control {
...
<body>
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <div class="breadcrumb">
                    <i class="fas fa-home"></i> / <a href="index.php">Noticias</a> / <span>Nueva</span>
                </div>
            </div>
        ...
        <div class="content-area">
            <section class="hero">
                <div>
                    <h1>Nueva <span>Noticia</span></h1>
                    <p>Completa los campos para publicar una nueva noticia</p>
                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="url" id="link_externo" name="link_externo" class="form-control" 
                                   value="<?php echo htmlspecialchars($_POST['link_externo'] ?? ''); ?>" 
                                   placeholder="https://..." required>
                            <div class="help-text">URL del medio externo donde está la noticia</div>
                        </div>
                        <div class="form-group">
